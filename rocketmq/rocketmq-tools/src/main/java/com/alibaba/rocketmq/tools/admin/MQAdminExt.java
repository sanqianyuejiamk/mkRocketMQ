...
public interface MQAdminExt extends MQAdmin {
    ...
    public void updateTopicLeval(final Set<String> addrs,final String topic,final String group,final int level, final long timeoutMillis)
    ...
    /**
     *  清空consumerGroup下的consumerOffset
     *
     * @param consumerGroup
     * @param topic
     * @param force
     ...
     * @throws MQClientException
     */
    List<RollbackStats> resetConsumerOffset_byOffset(String consumerGroup, String topic,
                                                  boolean force) throws RemotingException, MQBrokerException, InterruptedException,
            MQClientException;
     ...
     * @throws MQClientException
     */
    List<RollbackStats> resetConsumerOffset_byOffset(String consumerGroup, String topic,int queueId,
                                                     boolean force) throws RemotingException, MQBrokerException, InterruptedException,
            MQClientException;
