...
import com.alibaba.rocketmq.broker.task.ReSendTask;
...
public class BrokerStartup {
        ...
        try {
            ...
            if (commandLine.hasOption('c')) {
                ...
                if (file != null) {
                    ...
                    //获取redis配置
                    brokerConfig.setRedisAddr(properties.getProperty("redisAddr"));
                    brokerConfig.setRedisPort(Integer.parseInt(properties.getProperty("redisPort")));
                    brokerConfig.setRedisSwitch(Boolean.parseBoolean(properties.getProperty("redisSwitch")));
                    brokerConfig.setStartNamesrvAddr(properties.getProperty("namesrvAddr"));
    ...
    /**
     *  resend message every 30 seconds
     *
     */
    public static void startResendMessageTask() {
        Timer timer = new Timer();
        timer.schedule(new ReSendTask(SEMAPHORE), 0, 30 * 1000);
    }
}
