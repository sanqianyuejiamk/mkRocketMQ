...
//                log.info("-----[broker M]----- send message remote ip = {} , ExtFields = {}", ctx.channel().remoteAddress(), request.getExtFields()!=null?request.getExtFields():"");
...
//                log.info("-----[broker N]----- send message remote ip = {} , ExtFields = {}", ctx.channel().remoteAddress(), request.getExtFields()!=null?request.getExtFields():"");
