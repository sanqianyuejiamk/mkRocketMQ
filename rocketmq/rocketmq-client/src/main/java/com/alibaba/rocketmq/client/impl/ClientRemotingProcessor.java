...
public class ClientRemotingProcessor implements NettyRequestProcessor {
     ...
     * @throws RemotingCommandException
     */
    public RemotingCommand updateTopicLevel(ChannelHandlerContext ctx, RemotingCommand request)
            throws RemotingCommandException {
        final UpdateTopicLevelRequestHeader requestHeader =
                (UpdateTopicLevelRequestHeader) request
                        .decodeCommandCustomHeader(UpdateTopicLevelRequestHeader.class);
        log.info("-----------, clientRemotingProcessor updateTopicLevel topic = {} , group = {}",requestHeader.getTopic(),requestHeader.getGroup());

        this.mqClientFactory.updateTopicLevel(requestHeader.getTopic(), requestHeader.getGroup());
        return null;
    }
