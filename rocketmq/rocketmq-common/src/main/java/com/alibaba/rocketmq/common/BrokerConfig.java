...
public class BrokerConfig {
    ...
    @ImportantField
    public static String startNamesrvAddr;
    ...
    public static String getStartNamesrvAddr() {
        return startNamesrvAddr;
    }

    public static void setStartNamesrvAddr(String startNamesrvAddr) {
        BrokerConfig.startNamesrvAddr = startNamesrvAddr;
    }
}
